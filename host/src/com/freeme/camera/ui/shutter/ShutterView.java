...
class ShutterView extends RelativeLayout {
    ...
    protected void onFinishInflate() {
        ...
        mShutter = (ShutterButton) findViewById(R.id.shutter_image);
        ...
        if (((CameraActivity) getContext()).isVideoIntent()) {
            this.mShutter.setImageResource(R.drawable.ic_shutter_video);
        } else {
            this.mShutter.setImageResource(R.drawable.ic_shutter_photo);
        }
    }
