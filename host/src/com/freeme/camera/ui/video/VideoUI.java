 ...
 */
package com.freeme.camera.ui.video;
...
import com.freeme.camera.common.widget.RotateStrokeTextView;
import com.freeme.camera.common.widget.ScaleAnimationButton;
import com.freeme.camera.common.widget.StrokeTextView;
...
public class VideoUI implements IVideoUI {
    ...
    public void updateRecordingSize(long size) {
        ...
        int progress = (int) (size * PERCENTAGE_FOR_PROGRESS / mUISpec.recordingTotalSize);
