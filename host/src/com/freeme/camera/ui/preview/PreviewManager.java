...
package com.freeme.camera.ui.preview;
...
public class PreviewManager {
    ...
    public PreviewManager(IApp app) {
        ...
        int enabledValue = SystemProperties.getInt("debug.surface.enabled",
                DEFAULT_SURFACEVIEW_VALUE);

        int appVersion = SystemProperties.getInt("ro.mtk_camera_app_version", DEFAULT_APP_VERSION);
    ...
    public Bitmap getPreviewBitmap(){
        return mPreviewController.getPreviewBitmap(1);
    }
}
