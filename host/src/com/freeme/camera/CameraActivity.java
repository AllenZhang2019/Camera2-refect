...
import com.freeme.camera.common.debug.profiler.IPerformanceProfile;
import com.freeme.camera.common.debug.profiler.PerformanceTracker;
import com.freeme.camera.common.mode.IModeListener;
import com.freeme.camera.common.mode.ModeManager;
import com.freeme.camera.common.pluginmanager.PluginManagerAgent;
...
public class CameraActivity extends PermissionActivity implements IApp {
    ...
    private static final int MSG_SET_AUTO_EXIT_FLAG = 2;
    ...
    private String autoExitValue = "off";
    ...
    public PluginManagerAgent mPluginManagerAgent;
    ...
    protected void onCreateTasks(Bundle savedInstanceState) {
        ...
        setContentView(com.freeme.camera.R.layout.activity_main);
        mOrientationListener = new OrientationEventListenerImpl(this);
        //create common ui module.
        mCameraAppUI = new CameraAppUI(this);
        mPluginManagerAgent = new PluginManagerAgent(this);
    ...
    protected void onResumeTasks() {
        CameraAppService.setCurrentActivity(this);
    ...
    protected void onPauseTasks() {
        ...
        resetScreenOn();
        CameraAppService.exitCamera(this);
    }
    ...
    @Override
    public PluginManagerAgent getmPluginManagerAgent() {
        return mPluginManagerAgent;
    }

    private   int mCurrentCameraMode = 0;
    @Override
    public int getCurrentCameraMode() {
        return mCurrentCameraMode;
    }

    @Override
    public void setCurrentCameraMode(int value) {
        mCurrentCameraMode = value;
    }

    @Override
    public void setAutoExitValue(String value) {
        autoExitValue = value;
    }

    @Override
    public String getAutoExitValue() {
        return autoExitValue;
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MSG_SET_SCREEN_ON_FLAG:
                    ...
                    break;
                case MSG_SET_AUTO_EXIT_FLAG:
                    if(mIsResumed) {
                        if(getAutoExitValue() != null && getAutoExitValue().equals("on")) {
                            getActivity().finish();
                        }
                    }
    ...
    private void keepScreenOnForAWhile() {
        ...
        mMainHandler.removeMessages(MSG_SET_AUTO_EXIT_FLAG);
        mMainHandler.sendEmptyMessageDelayed(MSG_SET_AUTO_EXIT_FLAG,
                DELAY_MSG_SCREEN_SWITCH);
    }
