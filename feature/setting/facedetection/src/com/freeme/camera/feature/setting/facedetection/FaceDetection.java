...
public class FaceDetection extends SettingBase implements FaceDetectionSettingView.OnFaceDetectionClickListener {
    ...
    private FaceDetectionSettingView mSettingView;
    ...
    public void addViewEntry() {
        ...
        if (mSettingView == null) {
            mSettingView = new FaceDetectionSettingView(getKey());
            mSettingView.setFaceDetectionOnClickListener(this);
        }
    ...
    public void refreshViewEntry() {
        if (mSettingView != null) {
            ...
            mSettingView.setChecked(IFaceConfig.FACE_DETECTION_ON.equals(value));
            mSettingView.setEnabled(getEntryValues().size() > 1);
            //setValue(value);
            mSettingChangeRequester.sendSettingChangeRequest();
            mFaceDeviceCtrl.updateFaceDetectionStatus(value);
        }
    }
    ...
    public void onModeClosed(String modeKey) {
        ...
        if (!modeKey.startsWith("com.freeme.camera.feature.mode.pip.")) {
    ...
    private IApp.OnOrientationChangeListener mOrientationListener =
        ...
        public void onOrientationChanged(int orientation) {
            String value = mDataStore.getValue(
                    getKey(), IFaceConfig.FACE_DETECTION_ON, getStoreScope());
            if (IFaceConfig.FACE_DETECTION_ON.equals(value)) {
                updateFaceDisplayOrientation();
    ...
    @Override
    public void onFaceDetectionClicked(boolean checked) {
        String value = checked ? IFaceConfig.FACE_DETECTION_ON : IFaceConfig.FACE_DETECTION_OFF;
        LogHelper.d(TAG, "[onFaceDetectionClicked], value:" + value);
        setValue(value);
