...
public class RestoreSettingsEntry extends FeatureEntryBase {
    /**
     * create an entry.
     *
     ...
     */
    public RestoreSettingsEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return RestoreSettingsEntry.class.getName();
    }
