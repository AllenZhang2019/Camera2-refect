...
package com.freeme.camera.feature.setting.dng;
...
public class DngCaptureRequestConfig implements ICameraSetting.ICaptureRequestConfigure,
    ...
    private static final int MAX_RAW_CAPTURE_IMAGES = 1;
    ...
    public void configCaptureRequest(CaptureRequest.Builder captureBuilder) {
        ...
        int captureIntent = captureBuilder.get(CaptureRequest.CONTROL_CAPTURE_INTENT);
        if (mIsDngOn && captureIntent == CameraMetadata.CONTROL_CAPTURE_INTENT_STILL_CAPTURE
    ...
    private CameraCaptureSession.CaptureCallback mCaptureCallback
        ...
        public void onCaptureCompleted(CameraCaptureSession session, CaptureRequest request,
            ...
            int captureTemplate = result.get(result.CONTROL_CAPTURE_INTENT);
            if (mIsDngOn && captureTemplate == TEMPLATE_STILL_CAPTURE) {
    ...
    private Surface configRawSurface() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                synchronized (mCaptureObject) {
                    if (mRawCaptureHandler != null
                            && mRawCaptureHandlerThread.getLooper() != null) {
                        mRawCaptureHandlerThread.getLooper().quitSafely();
