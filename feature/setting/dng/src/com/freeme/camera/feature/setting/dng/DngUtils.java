...
public class DngUtils {
    ...
    public static ContentValues getContentValue(long shutterTime, String filePath, int width,
                                                int height, int orientation, Location location) {
        ...
        if (location != null) {
            rawContentValues.put(MediaStore.Images.ImageColumns.LATITUDE, location.getLatitude());
            rawContentValues.put(MediaStore.Images.ImageColumns.LONGITUDE, location.getLongitude());
        }
