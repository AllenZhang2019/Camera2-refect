...
/**
 * Focus entry which create focus setting. Focus setting instance will be corresponding to camera id
 * and the focus setting will be destroyed when camera release.
 */
public class FocusEntry extends FeatureEntryBase {
    ...
    public String getFeatureEntryName() {
        return FocusEntry.class.getName();
    }
