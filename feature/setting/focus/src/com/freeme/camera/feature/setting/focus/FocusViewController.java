...
public class FocusViewController {
    ...
    private void makeSureMultiZoneAfViewOnTree() {
        if (mFeatureRootView.findViewById(R.id.multi_focus_indicator) == null && mMultiZoneAfView
                != null) {
            LogHelper.w(TAG, "[makeSureMultiZoneAfViewOnTree] mMultiZoneAfView is not on view " +
                    "tree");
            mFeatureRootView.addView(mMultiZoneAfView);
        }
    }
