...
package com.freeme.camera.feature.setting;
...
import com.freeme.camera.common.setting.ICameraSetting.IParametersConfigure;
...
import com.freeme.camera.feature.setting.CsState.State;
...
public class ContinuousShot extends SettingBase implements IParametersConfigure,
    ...
    public void overrideValues(@Nonnull String headerKey, String currentValue,
        ...
        LogHelper.d(TAG, "[overrideValues] getValue() = " + getValue() + ", headerKey = "
                ...
                + supportValues);
        mIsContinuousShotSupport = mIsContinuousShotSupport &&
                CONTINUOUSSHOT_ON.equals(getValue());
    }
    ...
    private void postRestriction() {
        mSettingController.postRestriction(
                ContinuousShotRestriction.getRestriction().getRelation(getValue(), true));
        ...
        mSettingController.postRestriction(ContinuousShotRestriction.getFocusSoundRestriction()
                .getRelation(getValue(), true));
        if (CONTINUOUSSHOT_ON.equals(getValue())) {
            ...
            mSettingController.postRestriction(
                    ContinuousShotRestriction.getAsdRestriction().getRelation(getValue(), true));
        }
