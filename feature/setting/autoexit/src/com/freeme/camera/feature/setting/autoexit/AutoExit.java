...
public class AutoExit extends SettingBase implements AutoExitSettingView.OnAutoExitClickListener {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AutoExit.class.getSimpleName());

    private AutoExitSettingView mSettingView;
    private boolean mIsAutoExitSupported = false;
    ...
    public void addViewEntry() {
        ...
        if (mSettingView == null) {
            mSettingView = new AutoExitSettingView(getKey());
            mSettingView.setAutoExitOnClickListener(this);
        }
    ...
    public void refreshViewEntry() {
        if (mSettingView != null) {
            String value = mDataStore.getValue(getKey(), DEFAULT_AUTO_EXIT, getStoreScope());
    ...
    @Override
    public void onAutoExitClicked(boolean checked) {
        ...
        mApp.setAutoExitValue(value);

    }

    private void initSettingValue(){
        mIsAutoExitSupported = true;
