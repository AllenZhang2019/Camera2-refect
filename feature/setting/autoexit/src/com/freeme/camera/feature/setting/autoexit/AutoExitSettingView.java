...
package com.freeme.camera.feature.setting.autoexit;
...
public class AutoExitSettingView implements ICameraSettingView {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AutoExitSettingView.class.getSimpleName());

    private OnAutoExitClickListener mListener;
     ...
     *
     * @param listener The instance of {@link OnAutoExitClickListener}.
     */
    public void setAutoExitOnClickListener(OnAutoExitClickListener listener) {
        mListener = listener;
    }
