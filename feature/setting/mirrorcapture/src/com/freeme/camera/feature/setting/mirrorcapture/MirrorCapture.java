...
import com.freeme.camera.feature.setting.zsd.ZSDParametersConfig;
...
public class MirrorCapture extends SettingBase implements MirrorCaptureSettingView.OnMirrorCaptureClickListener {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(MirrorCapture.class.getSimpleName());

    private MirrorCaptureSettingView mSettingView;
    private boolean mIsMirrorCaptureSupported = false;
    ...
    public void addViewEntry() {
        ...
        if (mSettingView == null) {
            mSettingView = new MirrorCaptureSettingView(getKey());
            mSettingView.setMirrorCaptureOnClickListener(this);
        }
    ...
    public void refreshViewEntry() {
        if (mSettingView != null) {
            String value = mDataStore.getValue(getKey(), DEFAULT_MIRROR_CAPTURE, getStoreScope());
    ...
    @Override
    public void onMirrorCaptureClicked(boolean checked) {
    ...
    private void initSettingValue(){
        mIsMirrorCaptureSupported = true;
