...
public class GridLineSettingView implements ICameraSettingView {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(GridLineSettingView.class.getSimpleName());

    private OnGridLineClickListener mListener;
     ...
     *
     * @param listener The instance of {@link OnGridLineClickListener}.
     */
    public void setGridLineOnClickListener(OnGridLineClickListener listener) {
        mListener = listener;
    }
