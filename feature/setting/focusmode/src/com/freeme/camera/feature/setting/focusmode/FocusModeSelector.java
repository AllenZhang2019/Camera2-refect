 ...
 */
package com.freeme.camera.feature.setting.focusmode;
...
import com.freeme.camera.feature.setting.picturesize.RadioPreference;
...
public class FocusModeSelector extends PreferenceFragment {
    private static final LogUtil.Tag TAG
            = new LogUtil.Tag(FocusModeSelector.class.getSimpleName());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (toolbar != null) {
            toolbar.setTitle(getActivity().getString(R.string.pref_af_mode_title));
        }
        addPreferencesFromResource(R.xml.focus_mode_selector_preference);
    ...
    /**
     * Set focus mode entries and entry values.
     *
     * @param entries Focus mode entries.
     * @param entryValues Focus mode entry values.
     */
    ...
    /**
     * Focus mode preference click listener.
     */
