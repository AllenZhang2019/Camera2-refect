...
public class AntiFlicker extends SettingBase implements
    ...
    public IParametersConfigure getParametersConfigure() {
        if (mSettingChangeRequester == null) {
            AntiFlickerParametersConfig parametersConfig =
                    new AntiFlickerParametersConfig(this, mSettingDeviceRequester);
            mSettingChangeRequester = parametersConfig;
        }
        return (AntiFlickerParametersConfig) mSettingChangeRequester;
    }
