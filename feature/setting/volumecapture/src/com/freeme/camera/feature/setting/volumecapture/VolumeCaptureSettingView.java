...
public class VolumeCaptureSettingView implements ICameraSettingView {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(VolumeCaptureSettingView.class.getSimpleName());
     ...
     */
    public VolumeCaptureSettingView(String key) {
        mKey = key;
    }

    @Override
    public void loadView(PreferenceFragment fragment) {
        fragment.addPreferencesFromResource(R.xml.volume_capture_preference);
        mPref = (SwitchPreference) fragment.findPreference(mKey);
        mPref.setRootPreference(fragment.getPreferenceScreen());
        mPref.setId(R.id.volumecapture_setting);
        mPref.setContentDescription(fragment.getActivity().getResources()
                .getString(R.string.volume_capture_content_description));
     ...
     */
    public void setVolumeCaptureOnClickListener(OnVolumeCaptureClickListener listener) {
        mListener = listener;
    }
