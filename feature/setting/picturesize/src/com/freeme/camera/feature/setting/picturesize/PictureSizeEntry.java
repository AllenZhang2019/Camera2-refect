 ...
 * Picture size entry.
 */
public class PictureSizeEntry extends FeatureEntryBase {
     ...
     */
    public PictureSizeEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return PictureSizeEntry.class.getName();
    }
