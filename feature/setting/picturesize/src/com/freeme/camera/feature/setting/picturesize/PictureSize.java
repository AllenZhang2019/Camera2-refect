 ...
 */
package com.freeme.camera.feature.setting.picturesize;
...
public class PictureSize extends SettingBase implements
    ...
    public void refreshViewEntry() {
        if (mSettingView != null) {
            String value = mDataStore.getValue(getKey(), getDefaultPictureSize(), getStoreScope());
            mSettingView.setValue(value);
            mSettingView.setSummary(value);
    ...
    public void onValueInitialized(List<String> supportedPictureSize) {
        ...
        mDataStore.setValue(KEY_DEFAULT_PICTURE_SIZE, getDefaultPictureSize(), getStoreScope(), false);
    ...
    private String getDefaultPictureSize() {
        ...
        // entry values as the default value.
        if (defaultSize == null) {
            defaultSize = getEntryValues().get(0);
        }
