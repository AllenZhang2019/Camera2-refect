...
/**
 * Flash entry which create flash setting. Flash setting instance will be corresponding to camera id
 * and the flash setting will be destroyed when camera release.
 */
public class FlashEntry extends FeatureEntryBase {
    ...
    public String getFeatureEntryName() {
        return FlashEntry.class.getName();
    }
