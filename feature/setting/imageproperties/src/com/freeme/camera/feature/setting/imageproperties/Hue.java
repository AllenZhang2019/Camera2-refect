...
public class Hue extends SettingBase implements ImagePropertiesItem {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(Hue.class.getSimpleName());
    ...
    public IParametersConfigure getParametersConfigure() {
        if (mParametersConfigure == null) {
            mParametersConfigure = new HueParametersConfig(this, mSettingDeviceRequester);
        }
    ...
    public String getTitle() {
        return mActivity.getResources().getString(R.string.pref_camera_hue_title);
    }
}
