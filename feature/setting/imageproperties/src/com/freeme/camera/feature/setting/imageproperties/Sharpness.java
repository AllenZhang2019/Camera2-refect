...
public class Sharpness extends SettingBase implements ImagePropertiesItem {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(Sharpness.class.getSimpleName());
    ...
    public String getKey() {
        return KEY_SHARPNESS;
    }

    @Override
    public IParametersConfigure getParametersConfigure() {
        if (mParametersConfigure == null) {
            mParametersConfigure = new SharpnessParametersConfig(this, mSettingDeviceRequester);
        }
    ...
    public String getTitle() {
        return mActivity.getResources().getString(R.string.pref_camera_edge_title);
    }
}
