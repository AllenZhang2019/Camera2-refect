...
/**
 * Saturation setting item.
 */

public class Saturation extends SettingBase implements ImagePropertiesItem {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(Saturation.class.getSimpleName());
    ...
    public String getKey() {
        return KEY_SATURATION;
    }

    @Override
    public IParametersConfigure getParametersConfigure() {
        if (mParametersConfigure == null) {
            mParametersConfigure = new SaturationParametersConfig(this, mSettingDeviceRequester);
        }
    ...
    public String getTitle() {
        return mActivity.getResources().getString(R.string.pref_camera_saturation_title);
    }
}
