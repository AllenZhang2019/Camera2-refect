...
public class Brightness extends SettingBase implements ImagePropertiesItem {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(Brightness.class.getSimpleName());
    ...
    public IParametersConfigure getParametersConfigure() {
        if (mParametersConfigure == null) {
            mParametersConfigure = new BrightnessParametersConfig(this, mSettingDeviceRequester);
        }
    ...
    public String getTitle() {
        return mActivity.getResources().getString(R.string.pref_camera_brightness_title);
    }
}
