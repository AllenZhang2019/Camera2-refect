 ...
 */
package com.freeme.camera.feature.setting.imageproperties;
...
public class ImagePropertiesEntry extends FeatureEntryBase {

    /**
     * Image properties entry.
     *
     * @param context The instance of {@link Context}.
     * @param resources The instance of {@link Resources}.
     */
    public ImagePropertiesEntry(Context context, Resources resources) {
    ...
    public boolean isSupport(CameraApi currentCameraApi, Activity activity) {
        ...
        //        && currentCameraApi == CameraApi.API1;
        return  false;
    }

    @Override
    public String getFeatureEntryName() {
        return ImagePropertiesEntry.class.getName();
    }
    ...
    public Object createInstance() {
        ...
        imageProperties.addItems(brightness);
        imageProperties.addItems(contrast);
        imageProperties.addItems(hue);
        imageProperties.addItems(saturation);
        imageProperties.addItems(sharpness);
