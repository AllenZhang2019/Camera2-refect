 ...
 */
package com.freeme.camera.feature.setting.exposure;
...
/**
 * Exposure entry which create exposure setting. Exposure setting instance will be corresponding to
 * camera id and the exposure setting will be destroyed when camera release.
 */
public class ExposureEntry extends FeatureEntryBase {
    ...
    public String getFeatureEntryName() {
        return ExposureEntry.class.getName();
    }
