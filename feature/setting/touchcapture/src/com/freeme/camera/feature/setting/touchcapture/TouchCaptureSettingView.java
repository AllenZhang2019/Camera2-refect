...
package com.freeme.camera.feature.setting.touchcapture;
...
public class TouchCaptureSettingView implements ICameraSettingView {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(TouchCaptureSettingView.class.getSimpleName());

    private OnVolumeCaptureClickListener mListener;
     ...
     *
     * @param listener The instance of {@link OnVolumeCaptureClickListener}.
     */
    public void setTouchCaptureOnClickListener(OnVolumeCaptureClickListener listener) {
        mListener = listener;
    }
