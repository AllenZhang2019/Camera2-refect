...
public class TouchCapture extends SettingBase implements TouchCaptureSettingView.OnVolumeCaptureClickListener {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(TouchCapture.class.getSimpleName());

    private TouchCaptureSettingView mSettingView;
    private boolean mIsTouchCaptureSupported = false;
    ...
    public void addViewEntry() {
        ...
        if (mSettingView == null) {
            mSettingView = new TouchCaptureSettingView(getKey());
            mSettingView.setTouchCaptureOnClickListener(this);
        }
    ...
    public void refreshViewEntry() {
        if (mSettingView != null) {
            String value = mDataStore.getValue(getKey(), DEFAULT_TOUCH_CAPTURE , getStoreScope());
