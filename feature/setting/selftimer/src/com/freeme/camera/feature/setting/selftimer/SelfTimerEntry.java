...
public class SelfTimerEntry extends FeatureEntryBase {
     ...
     */
    public SelfTimerEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return SelfTimerEntry.class.getName();
    }
