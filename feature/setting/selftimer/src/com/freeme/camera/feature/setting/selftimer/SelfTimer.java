...
public class SelfTimer extends SettingBase implements IAppUiListener.OnShutterButtonListener {
    ...
    private SelfTimerViewController mSelfTimerViewController;
    ...
    public void init(IApp app,
        ...
        if (mSelfTimerViewController == null) {
            mSelfTimerViewController = new SelfTimerViewController(this, app);
        }
    }
    ...
    public void addViewEntry() {
        ...
        mSelfTimerViewController.addQuickSwitchIcon();
        mSelfTimerViewController.showQuickSwitchIcon(getEntryValues().size() > 1);
    }
    ...
    public void removeViewEntry() {
        ...
        mSelfTimerViewController.removeQuickSwitchIcon();
    }
    ...
    public void refreshViewEntry() {
        ...
        if (num <= 1) {
            mSelfTimerViewController.showQuickSwitchIcon(false);
        } else {
            mSelfTimerViewController.showQuickSwitchIcon(true);
        }
    ...
    public void onSelfTimerValueChanged(String value) {
        if (!value.equals(getValue())) {
            ...
            mDataStore.setValue(SELF_TIMER_STATE_KEY, value, getStoreScope(), false, true);
        }
    }
    ...
    public void onModeClosed(String modeKey) {
        mSelfTimerViewController.hideSelfTimerChoiceView();
