...
public class FocusSound extends SettingBase implements FocusSoundSettingView.OnFocusSoundClickListener {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(FocusSound.class.getSimpleName());

    private FocusSoundSettingView mSettingView;
    private boolean mIsFocusSoundSupported = false;
    ...
    public void addViewEntry() {
        ...
        if (mSettingView == null) {
            mSettingView = new FocusSoundSettingView(getKey());
    ...
    public void refreshViewEntry() {
        if (mSettingView != null) {
            String value = mDataStore.getValue(getKey(), DEFAULT_FOCUS_SOUND, getStoreScope());
    ...
    @Override
    public void onFocusSoundClicked(boolean checked) {
