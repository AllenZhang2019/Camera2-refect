...
package com.freeme.camera.feature.setting.focussound;
...
public class FocusSoundSettingView implements ICameraSettingView {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(FocusSoundSettingView.class.getSimpleName());

    private OnFocusSoundClickListener mListener;
     ...
     *
     * @param listener The instance of {@link OnFocusSoundClickListener}.
     */
    public void setVolumeCaptureOnClickListener(OnFocusSoundClickListener listener) {
        mListener = listener;
    }
