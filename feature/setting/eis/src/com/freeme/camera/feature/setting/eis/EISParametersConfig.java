...
package com.freeme.camera.feature.setting.eis;
...
public class EISParametersConfig implements ICameraSetting.IParametersConfigure {
    ...
    private void setMtkCameraMode(Camera.Parameters parameters) {
        Intent intent = mActivity.getIntent();
        String action = intent.getAction();
        if (!MediaStore.ACTION_VIDEO_CAPTURE.equals(action)
                && parameters.get(MTK_CAMERA_MODE) != null) {
            parameters.set(MTK_CAMERA_MODE, CAMERA_MODE_MTK_VDO);
        }
    }
}
