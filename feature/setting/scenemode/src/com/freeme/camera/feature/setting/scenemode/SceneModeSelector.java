 ...
 */
package com.freeme.camera.feature.setting.scenemode;
...
public class SceneModeSelector extends PreferenceFragment {
    private static final LogUtil.Tag TAG
            = new LogUtil.Tag(SceneModeSelector.class.getSimpleName());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (toolbar != null) {
            toolbar.setTitle(getActivity().getResources()
                    .getString(R.string.pref_camera_scenemode_title));
        }
