...
public class ShutterSound extends SettingBase implements ShutterSoundSettingView.OnShutterSoundClickListener {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(ShutterSound.class.getSimpleName());


    private ShutterSoundSettingView mSettingView;
    ...
    public void addViewEntry() {
        ...
        if (mSettingView == null) {
            mSettingView = new ShutterSoundSettingView(getKey());
            mSettingView.setShutterSoundOnClickListener(this);
        }
    ...
    public void refreshViewEntry() {
        if (mSettingView != null) {
            String value = mDataStore.getValue(getKey(), DEFAULT_SHUTTER_SOUND, getStoreScope());
    ...
    public IParametersConfigure getParametersConfigure() {
        ...
        if (mSettingChangeRequester == null) {
            ShutterSoundParametersConfig config = new ShutterSoundParametersConfig(this, mSettingDeviceRequester);
            mSettingChangeRequester = config;
        }
        return (ShutterSoundParametersConfig) mSettingChangeRequester;
    }
    ...
    @Override
    public void onShutterSoundClicked(boolean checked) {
        String value = checked ? VALUE_ON : VALUE_OFF;
        LogHelper.d(TAG, "[onShutterSoundClicked], value:" + value);
        setValue(value);
    ...
    public boolean getShutterSoundState()
    {
