...
public class ShutterSoundSettingView implements ICameraSettingView {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(ShutterSoundSettingView.class.getSimpleName());

    private OnShutterSoundClickListener mListener;
     ...
     *
     * @param listener The instance of {@link OnShutterSoundClickListener}.
     */
    public void setShutterSoundOnClickListener(OnShutterSoundClickListener listener) {
        mListener = listener;
    }
