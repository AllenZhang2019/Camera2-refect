...
public class ShutterSoundRequestConfig implements ICameraSetting.ICaptureRequestConfigure {
    private SettingDevice2Requester mDeviceRequester;

    /**
     * Zsd capture request configure constructor.
     * @param volumeCapture The instance of {@link ShutterSound}.
     * @param device2Requester The implementer of {@link SettingDevice2Requester}.
     */
    public ShutterSoundRequestConfig(ShutterSound volumeCapture, SettingDevice2Requester device2Requester) {
