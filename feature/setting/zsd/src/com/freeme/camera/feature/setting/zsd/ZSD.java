...
package com.freeme.camera.feature.setting.zsd;
...
public class ZSD extends SettingBase implements ZSDSettingView.OnZsdClickListener {
    ...
    public void refreshViewEntry() {
        if (mSettingView != null) {
            String value = mDataStore.getValue(getKey(), getDefaultZSD(), getStoreScope());
    ...
    private String getDefaultZSD() {
        int defaultIndex = 0;
        String defaultZSD = getSupportedPlatformValues().get(defaultIndex);
        return defaultZSD;
    }
}
