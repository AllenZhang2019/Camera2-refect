...
public class AboutCamera extends SettingBase implements AboutCameraSettingView.OnAboutCameraConfirmListener{
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AboutCamera.class.getSimpleName());


    private AboutCameraSettingView mSettingView;
    private boolean mIsAboutCameraSupported = true;
    ...
    public void addViewEntry() {
        ...
        if (mSettingView == null) {
            mSettingView = new AboutCameraSettingView(getKey() , mApp);
            mSettingView.setAboutCameraConfirmedListener(this);
    ...
    @Override
    public void onAboutCameraConfirmed() {
