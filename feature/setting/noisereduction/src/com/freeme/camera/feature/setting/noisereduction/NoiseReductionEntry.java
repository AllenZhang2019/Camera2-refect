...
package com.freeme.camera.feature.setting.noisereduction;
...
/**
 * NoiseReduction entry for feature provider.
 */

public class NoiseReductionEntry extends FeatureEntryBase {
    private NoiseReduction mNoiseReduction = null;
    ...
    public String getFeatureEntryName() {
        return NoiseReductionEntry.class.getName();
    }
    ...
    public Object createInstance() {
        mNoiseReduction = new NoiseReduction();
