...
public class NaviLineImageView extends ImageView {
    private static final LogUtil.Tag TAG = new LogUtil.
            Tag(NaviLineImageView.class.getSimpleName());
    ...
    /**
     * The constructor of NaviLineImageView.
     * @param context
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        LogHelper.v(TAG, "[onLayout]changed=" + changed + " left =" + left + " top = " + top
    ...
    /**
     * Layout NaviLineImageView.
     * @param l The left position.
     * @param t The top position.
     * @param r The right position.
     * @param b The bottom position.
     */
    public void layout(int l, int t, int r, int b) {
        LogHelper.v(TAG, "[layout]left =" + l + " top = " + t + " right = " + r + " bottom = " + b);
    ...
    public void setLayoutPosition(int l, int t, int r, int b) {
        LogHelper.v(TAG, "[setLayoutPosition] left =" + l + " top = " + t + " right = " + r
                + " bottom = " + b);
        mLeft = l;
        mTop = t;
        mRight = r;
