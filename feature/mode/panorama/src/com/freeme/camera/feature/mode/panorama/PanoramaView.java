...
import com.freeme.camera.common.widget.RotateLayout.OnSizeChangedListener;
...
public class PanoramaView {
     ...
     *             PanoramaMode.INFO_UPDATE_PROGRESS,
     *             PanoramaMode.INFO_UPDATE_MOVING,
     *             PanoramaMode.INFO_START_ANIMATION,
     *             PanoramaMode.INFO_IN_CAPTURING,
     *             PanoramaMode.INFO_OUT_OF_CAPTURING.
    ...
    private void updateMovingUI(int xy, int direction, boolean shown) {
        LogHelper.d(TAG, "[updateMovingUI] xy:" + xy + ", direction:" + direction +
                ", shown:" + shown);
    ...
    private void updateUIShowingMatrix(int x, int y, int direction) {
        ...
        LogHelper.v(TAG, "[updateUIShowingMatrix]DisplayMatrix x = " + pts[0] + " y = " + pts[1]);
