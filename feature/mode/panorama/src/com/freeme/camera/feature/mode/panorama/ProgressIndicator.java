...
package com.freeme.camera.feature.mode.panorama;
...
/**
 * A @{code ImageView} used for progress indicator in panorama view.
 */
public class ProgressIndicator {
    private static final LogUtil.Tag TAG = new LogUtil.
            Tag(ProgressIndicator.class.getSimpleName());
    ...
    /**
     * The constructor for ProgressIndicator.
     * @param activity
     *         the camera activity
     * @param blockNumber
     *         total block number
     * @param drawBlockSizes
     *         block array
     */
    public ProgressIndicator(Activity activity, int blockNumber,
            int[] drawBlockSizes) {
        mBlockPadding = 4;
        ...
        mProgressBars.setImageDrawable(new ProgressBarDrawable(activity,
                mProgressBars, blockSizes, mBlockPadding));
        getIndicatorMargin();
        requestLayout();
    }
    ...
    public ProgressIndicator(Activity activity) {
        ...
        if (mProgressView == null) {
            LogHelper.w(TAG, "mProgressView is null,return!");
            return;
        }
        mProgressView.setVisibility(View.VISIBLE);
        mProgressBars = (ImageView) activity.findViewById(R.id.progress_bars);
    ...
    /**
     * Set progress view visible or invisible.
     * @param visibility The value setVisibility for progress view.
     */
    ...
    /**
     * Set progress view level.
     * @param progress The level to be set.
     */
    ...
    private void getIndicatorMargin() {
        ...
        LogHelper.d(TAG, "[getIndicatorMargin]sIndicatorMarginLong = "
                + sIndicatorMarginLong + " sIndicatorMarginShort = "
                + sIndicatorMarginShort);
    }
}
