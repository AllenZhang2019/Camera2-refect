...
class IKODevice2Controller implements
        IIKODeviceController,
        CaptureSurface.ImageCallback,
        ISettingManager.SettingDevice2Requester {
    private static final Tag TAG = new Tag(IKODevice2Controller.class.getSimpleName());
     ...
     */
    IKODevice2Controller(@Nonnull Activity activity, @Nonnull ICameraContext context) {
        LogHelper.d(TAG, "[IKODevice2Controller]");
        mActivity = activity;
