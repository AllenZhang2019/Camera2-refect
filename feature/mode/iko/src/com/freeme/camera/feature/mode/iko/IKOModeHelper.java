...
public class IKOModeHelper {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(IKOModeHelper.class.getSimpleName());
     ...
     */
    public IKOModeHelper(ICameraContext cameraContext) {
