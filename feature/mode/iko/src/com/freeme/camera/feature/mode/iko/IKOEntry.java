 ...
 */
public class IKOEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(IKOEntry.class.getSimpleName());
    private static final String MODE_ITEM_TYPE = "Picture";

    private static final int MODE_ITEM_PRIORITY = 20;
     ...
     */
    public IKOEntry(Context context, Resources resources) {
    ...
    public ModeItem getModeItem() {
        ...
        modeItem.mModeName = mContext.getString(R.string.iko_dialog_title);
        modeItem.mSupportedCameraIds = new String[]{"0","1"};
        modeItem.mMode = "IKO";
        modeItem.mTitle = this.mContext.getResources().getString(R.string.iko_dialog_title);
        return modeItem;
    }
