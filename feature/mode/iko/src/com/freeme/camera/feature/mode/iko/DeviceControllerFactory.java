...
/**
 * A factory used to create the instance of {@link IIKODeviceController}.
 */
public  class DeviceControllerFactory {
    /**
     * Create the instance of {@link IIKODeviceController} by API type.
     *
     ...
     */
    @Nonnull
    public IIKODeviceController createDeviceController(
            @Nonnull Activity activity,
            @Nonnull CameraApi cameraApi,
            @Nonnull ICameraContext context) {
        if (CameraApi.API1 == cameraApi) {
            return new IKODeviceController(activity, context);
        }
        return new IKODevice2Controller(activity, context);
    }
}
