 ...
 */
public class QrCodeScanEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(QrCodeScanEntry.class.getSimpleName());
    private static final String MODE_ITEM_TYPE = "Picture";

    private static final int MODE_ITEM_PRIORITY = 55;
     ...
     */
    public QrCodeScanEntry(Context context, Resources resources) {
    ...
    public boolean isSupport(CameraApi currentCameraApi, Activity activity) {
        ...
        if(((CameraActivity)activity).mPluginManagerAgent.getModules().get(FreemeSceneModeData.FREEME_SCENE_MODE_POSE_ID) != null) {
            support = true;
        }
    ...
    public String getFeatureEntryName() {
        return QrCodeScanEntry.class.getName();
    }
    ...
    public Object createInstance() {
        return new ExtrioPlugMode(FreemeSceneModeData.FREEME_SCENE_MODE_QRCODE_ID);
    }
    /**
    ...
    public ModeItem getModeItem() {
        ...
        modeItem.mModeName = mContext.getString(R.string.qrcodescan_dialog_title);
        modeItem.mSupportedCameraIds = new String[]{"0"};
        modeItem.mMode = "Qr";
        modeItem.mTitle = this.mContext.getResources().getString(R.string.qrcodescan_dialog_title);
        return modeItem;
    }
