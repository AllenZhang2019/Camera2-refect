 ...
 */
public class CameraLargeEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(CameraLargeEntry.class.getSimpleName());
     ...
     */
    public CameraLargeEntry(Context context, Resources resources) {
    ...
    public boolean isSupport(CameraApi currentCameraApi, Activity activity) {
        ...
        if(((CameraActivity)activity).mPluginManagerAgent.getModules().get(FreemeSceneModeData.FREEME_SCENE_MODE_BM_ID) != null) {
            support = true;
        }
    ...
    public String getFeatureEntryName() {
        return CameraLargeEntry.class.getName();
    }
    ...
    public Object createInstance() {
        return new ExtrioPlugMode(FreemeSceneModeData.FREEME_SCENE_MODE_BM_ID);
    }
    /**
    ...
    public ModeItem getModeItem() {
        ...
        modeItem.mModeName = mContext.getString(R.string.large_dialog_title);
        modeItem.mSupportedCameraIds = new String[]{"0"};
        modeItem.mMode = "Large";
        modeItem.mTitle = this.mContext.getResources().getString(R.string.large_dialog_title);
        return modeItem;
    }
