...
public class ExtrioPlugModeHelper {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(ExtrioPlugModeHelper.class.getSimpleName());
     ...
     */
    public ExtrioPlugModeHelper(ICameraContext cameraContext) {
