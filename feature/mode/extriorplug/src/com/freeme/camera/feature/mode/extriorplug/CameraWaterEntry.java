 ...
 */
public class CameraWaterEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(CameraWaterEntry.class.getSimpleName());
     ...
     */
    public CameraWaterEntry(Context context, Resources resources) {
    ...
    public boolean isSupport(CameraApi currentCameraApi, Activity activity) {
        ...
        if(!isThirdPartyIntent(activity) && ((CameraActivity)activity).mPluginManagerAgent.getModules().get(FreemeSceneModeData.FREEME_SCENE_MODE_WATERMARK_ID) != null) {
            support = true;
        }
    ...
    public String getFeatureEntryName() {
        return CameraWaterEntry.class.getName();
    }
    ...
    public Object createInstance() {
        return new ExtrioPlugMode(FreemeSceneModeData.FREEME_SCENE_MODE_WATERMARK_ID);
    }
    /**
    ...
    public ModeItem getModeItem() {
        ...
        modeItem.mModeName = mContext.getString(R.string.water_dialog_title);
        modeItem.mSupportedCameraIds = new String[]{"0"};
        modeItem.mMode = "Water";
        modeItem.mTitle = this.mContext.getResources().getString(R.string.water_dialog_title);
        return modeItem;
    }
