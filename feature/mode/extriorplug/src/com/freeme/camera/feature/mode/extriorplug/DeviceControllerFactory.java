...
/**
 * A factory used to create the instance of {@link IExtrioPlugDeviceController}.
 */
public  class DeviceControllerFactory {
    /**
     * Create the instance of {@link IExtrioPlugDeviceController} by API type.
     *
     ...
     */
    @Nonnull
    public IExtrioPlugDeviceController createDeviceController(
            @Nonnull Activity activity,
            @Nonnull CameraApi cameraApi,
            @Nonnull ICameraContext context) {
        if (CameraApi.API1 == cameraApi) {
            return new ExtrioPlugDeviceController(activity, context);
        }
        return new ExtrioPlugDevice2Controller(activity, context);
    }
}
