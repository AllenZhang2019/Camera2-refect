 ...
 */
public class CameraChildrenEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(CameraChildrenEntry.class.getSimpleName());
     ...
     */
    public CameraChildrenEntry(Context context, Resources resources) {
    ...
    public boolean isSupport(CameraApi currentCameraApi, Activity activity) {
        ...
        if(!isThirdPartyIntent(activity) && ((CameraActivity)activity).mPluginManagerAgent.getModules().get(FreemeSceneModeData.FREEME_SCENE_MODE_CHILD_ID) != null) {
            support = true;
        }
    ...
    public String getFeatureEntryName() {
        return CameraChildrenEntry.class.getName();
    }
    ...
    public Object createInstance() {
        return new ExtrioPlugMode(FreemeSceneModeData.FREEME_SCENE_MODE_CHILD_ID);
    }
    /**
    ...
    public ModeItem getModeItem() {
        ...
        modeItem.mModeName = mContext.getString(R.string.children_dialog_title);
        modeItem.mSupportedCameraIds = new String[]{"0","1"};
        modeItem.mMode = "Children";
        modeItem.mTitle = this.mContext.getResources().getString(R.string.children_dialog_title);
        return modeItem;
    }
