...
import com.freeme.camera.common.device.v2.Camera2CaptureSessionProxy;
import com.freeme.camera.common.device.v2.Camera2Proxy;
import com.freeme.camera.common.device.v2.Camera2Proxy.StateCallback;
...
import com.freeme.camera.common.setting.ISettingManager.SettingDevice2Configurator;
...
class ExtrioPlugDevice2Controller implements
        IExtrioPlugDeviceController,
        CaptureSurface.ImageCallback,
        ISettingManager.SettingDevice2Requester {
    private static final Tag TAG = new Tag(ExtrioPlugDevice2Controller.class.getSimpleName());
     ...
     */
    ExtrioPlugDevice2Controller(@Nonnull Activity activity, @Nonnull ICameraContext context) {
        LogHelper.d(TAG, "[QrCodeScanDevice2Controller]");
        mActivity = activity;
    ...
    @Override
    public Builder createAndConfigRequest(int templateType) {
    ...
    private void updatePreviewSize() {
        SettingController controller = mSettingManager.getSettingController();
