...
class SlrDevice2Controller implements
        ISlrDeviceController,
        CaptureSurface.ImageCallback,
        ISettingManager.SettingDevice2Requester {
    private static final Tag TAG = new Tag(SlrDevice2Controller.class.getSimpleName());
     ...
     */
    SlrDevice2Controller(@Nonnull Activity activity, @Nonnull ICameraContext context) {
        LogHelper.d(TAG, "[SlrDevice2Controller]");
        mActivity = activity;
