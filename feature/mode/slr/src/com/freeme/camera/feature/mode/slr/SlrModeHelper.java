...
public class SlrModeHelper {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(SlrModeHelper.class.getSimpleName());
     ...
     */
    public SlrModeHelper(ICameraContext cameraContext) {
