...
/**
 * A factory used to create the instance of {@link ISlrDeviceController}.
 */
public  class DeviceControllerFactory {
    /**
     * Create the instance of {@link ISlrDeviceController} by API type.
     *
     ...
     */
    @Nonnull
    public ISlrDeviceController createDeviceController(
            @Nonnull Activity activity,
            @Nonnull CameraApi cameraApi,
            @Nonnull ICameraContext context) {
        if (CameraApi.API1 == cameraApi) {
            return new SlrDeviceController(activity, context);
        }
        return new SlrDevice2Controller(activity, context);
    }
}
