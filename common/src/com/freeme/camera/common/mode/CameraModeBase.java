...
public abstract class CameraModeBase implements
    ...
    private static final String KEY_VOLUME_CAPTURE = "key_volume_capture";
    public static final String KEY_MIRROR_CAPTURE = "key_mirror_capture";
    public static final String KEY_AUTO_EXIT = "key_auto_exit";
    ...
    public static final boolean DEBUG_STEREO_SINGLE_ENABLE =
            SystemProperties.getInt("debug.stereo.single_main2", 0) == 1 ? true : false
    ...
    private String mPrevVolumeCapture = "on";
    public String mPrevMirrorCapture = "on";
    ...
    public void resume(@Nonnull DeviceUsage deviceUsage) {
        ...
        String autoExitde = controller.queryValue(KEY_AUTO_EXIT);
        mIApp.setAutoExitValue(autoExitde);
    }
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_CAMERA:
                ...
                ISettingManager.SettingController controller = getSettingManager().getSettingController();
                String volumeCapturede = controller.queryValue(KEY_VOLUME_CAPTURE);
                if(mPrevVolumeCapture.equals(volumeCapturede)) {
