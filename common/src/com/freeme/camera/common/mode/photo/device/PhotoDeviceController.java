...
package com.freeme.camera.common.mode.photo.device;
...
import com.freeme.camera.common.device.CameraOpenException;
import com.freeme.camera.common.device.v1.CameraProxy;
import com.freeme.camera.common.mode.photo.DeviceInfo;
import com.freeme.camera.common.setting.ISettingManager;
...
public class PhotoDeviceController implements IDeviceController, ISettingManager.SettingDeviceRequester {
    ...
    PhotoDeviceController(@Nonnull Activity activity, @Nonnull ICameraContext context) {
        ...
        mActivity = activity;
        mCameraDeviceManager = mICameraContext.getDeviceManager(CameraDeviceManagerFactory.CameraApi.API1);
    }
    ...
    private class PhotoDeviceHandler extends Handler {
         ...
         */
        public PhotoDeviceHandler(Looper looper, ISettingManager.SettingDeviceRequester requester) {
            super(looper);
        ...
        private String mPrevShutterSound = "on";
        ...
        private void setPreviewParameters(Camera.Parameters parameters) {
            ...
            String shutterSoundde = controller.queryValue(KEY_SHUTTER_SOUND);
            if(mPrevShutterSound.equals(shutterSoundde)) {
                mCameraProxy.enableShutterSound(true);
            } else {
                mCameraProxy.enableShutterSound(false);
            }
