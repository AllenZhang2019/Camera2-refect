...
package com.freeme.camera.common.mode;

import android.app.Activity;
import android.content.Intent;
import android.provider.MediaStore;

import com.freeme.camera.common.CameraContext;
...
import com.freeme.camera.common.loader.FeatureProvider;
import com.freeme.camera.common.CameraContext;
import com.freeme.camera.common.IAppUi;
import com.freeme.camera.common.IAppUiListener;
import com.freeme.camera.common.ICameraContext;
...
import com.freeme.camera.common.loader.FeatureProvider;
import com.freeme.camera.common.loader.FeatureProvider.FeatureLoadDoneListener;
...
public class ModeManager implements IModeListener, IAppUiListener.OnModeChangeListener {
    ...
    private static final String DEFAULT_CAMERA_MODE =
            "com.freeme.camera.common.mode.photo.PhotoModeEntry";
    private static final String DEFAULT_INTENT_PHOTO_MODE =
            "com.freeme.camera.common.mode.photo.intent.IntentPhotoModeEntry";
    private static final String DEFAULT_INTENT_VIDEO_MODE =
            "com.freeme.camera.common.mode.video.intentvideo.IntentVideoModeEntry";
    ...
    /**
     * An implement of {@link FeatureProvider.FeatureLoadDoneListener} for mode.
     */
    private class FeatureLoadListener implements FeatureProvider.FeatureLoadDoneListener {
        @Override
        public void onBuildInLoadDone(String cameraId, CameraDeviceManagerFactory.CameraApi cameraApi) {
        ...
        @Override
        public void onPluginLoadDone(String cameraId, CameraDeviceManagerFactory.CameraApi cameraApi) {
