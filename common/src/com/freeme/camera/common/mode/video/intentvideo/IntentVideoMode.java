...
package com.freeme.camera.common.mode.video.intentvideo;
...
import com.freeme.camera.common.mode.video.VideoMode;
    ...
    protected List<Relation> getRecordedRestriction(boolean isRecording) {
        ...
        if (isRecording) {
            if (!mVideoHelper.isPDAFSupported(mCameraApi)) {
                relationList.add(IntentRestriction.getRecordingRelationGroupForMode()
                        .getRelation("recording", true));
            }
        } else {
            relationList.add(IntentRestriction.getRecordingRelationGroupForMode()
                    .getRelation("stop-recording", true));
        }
        return relationList;
    }
