...
package com.freeme.camera.common.mode.video;
...
import com.freeme.camera.common.mode.video.device.IDeviceController;
...
import com.freeme.camera.common.device.v1.CameraProxy;
import com.freeme.camera.common.mode.video.device.IDeviceController;
import com.freeme.camera.common.mode.video.recorder.IRecorder;
import com.freeme.camera.common.setting.ISettingManager;
import com.freeme.camera.common.utils.CameraUtil;
import com.freeme.camera.common.utils.CameraUtil.TableList;
import com.freeme.camera.common.utils.Size;
...
//            MEDIA_INFO_WRITE_SLOW
     ...
     */
    public void startSwitchCameraAnimation(String cameraId) {
        IAppUi.AnimationData data = prepareAnimationData(mCameraPreviewData,
                mPreviewSize.getWidth(), mPreviewSize.getHeight(), mPreviewFormat, cameraId);
        mApp.getAppUi().animationStart(IAppUi.AnimationType.TYPE_SWITCH_CAMERA, data);
    }
    /**
     * Start change mode animation.
     * @param cameraId the current camera id.
     */
    public void startChangeModeAnimation(String cameraId) {
        if (mCameraPreviewData != null) {
            IAppUi.AnimationData data = prepareAnimationData(mCameraPreviewData,
                    mPreviewSize.getWidth(), mPreviewSize.getHeight(), mPreviewFormat, cameraId);
            mApp.getAppUi().animationStart(IAppUi.AnimationType.TYPE_SWITCH_MODE, data);
        }
    }
    /**
     ...
     */
    public void updateSize(Size previewSize) {
    ...
    private ContentValues createVideoValues() {
        ...
        if (CameraUtil.isColumnExistInDB(mActivity, CameraUtil.TableList.VIDEO_TABLE, "orientation")) {
