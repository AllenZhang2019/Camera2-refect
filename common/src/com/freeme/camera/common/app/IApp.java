...
package com.freeme.camera.common.app;
...
public interface IApp {
    ...
    PluginManagerAgent getmPluginManagerAgent();

    int getCurrentCameraMode();

    void setCurrentCameraMode(int value);


    void setAutoExitValue(String value);

    String getAutoExitValue();
