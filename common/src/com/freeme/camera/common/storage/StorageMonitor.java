...
package com.freeme.camera.common.storage;
...
class StorageMonitor {
    ...
    private final CopyOnWriteArrayList<IStorageService.IStorageStateListener> mIStorageStateListener
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            case Intent.ACTION_MEDIA_EJECT:
                ...
                if (mStorage.isSameStorage(intent)) {
                    for (IStorageService.IStorageStateListener listener : mIStorageStateListener) {
     ...
     */
    public void registerStorageStateListener(IStorageService.IStorageStateListener listener) {
        mStorage.updateDefaultDirectory();
     ...
     *            who want to know storage state change.
     */
    public void unRegisterStorageStateListener(IStorageService.IStorageStateListener listener) {
