...
public class MediaSaver {
    ...
    public void addSaveRequest(@NonNull byte[] pictureData, ContentValues contentValues,
        ...
        Request request = new Request(pictureData, contentValues, filePath, listener, null);
        addRequest(request);
    }
    ...
    public void addSaveRequest(@NonNull ContentValues contentValues, String filePath,
        ...
        Request request = new Request(null, contentValues, filePath, listener, null);
        addRequest(request);
    }
    ...
    public void updateSaveRequest(@NonNull byte[] pictureData,
        ...
        Request request = new Request(pictureData, contentValues, filePath, null, uri);
        addRequest(request);
    }
    ...
    private class Request {
        ...
        public Request(byte[] data, ContentValues values, String filePath,
                MediaSaverListener listener, Uri uri) {
            this.mData = data;
            this.mValues = values;
