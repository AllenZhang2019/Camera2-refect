...
package com.freeme.camera.common.device.v2;
...
import com.freeme.camera.common.device.CameraProxyBase;
import com.freeme.camera.common.device.CameraStateCallback;
import com.google.common.base.Preconditions;

import com.freeme.camera.common.device.CameraDeviceManagerFactory.CameraApi;
import com.freeme.camera.common.device.CameraProxyBase;
import com.freeme.camera.common.device.CameraStateCallback;
import com.freeme.camera.common.utils.AtomAccessor;
 ...
 */
public class Camera2Proxy extends CameraProxyBase implements AutoCloseable {
    ...
    public Camera2Proxy(@Nonnull String cameraId, @Nonnull CameraDevice device,
        ...
        Preconditions.checkNotNull(cameraId, "Create Camera2Prxoy,the id must not null");
        Preconditions.checkNotNull(device, "Create Camera2Prxoy,camera device must not null");
        Preconditions.checkNotNull(requestHandler,
                        "Create Camera2Prxoy,request handler must not null");
        mCameraId = cameraId;
    ...
    public void close() {
        synchronized (mInterfaceLock) {
            ...
            Message msg = mRequestHandler.obtainMessage(Camera2Actions.CLOSE_DEVICE);
            mAtomAccessor.sendAtomMessageAndWait(mRequestHandler, msg);
        }
    }
