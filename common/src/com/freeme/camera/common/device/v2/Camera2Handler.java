...
import com.freeme.camera.common.device.HistoryHandler;
import com.google.common.base.Preconditions;

import com.freeme.camera.common.debug.LogHelper;
import com.freeme.camera.common.debug.LogUtil.Tag;
import com.freeme.camera.common.device.HistoryHandler;
import com.freeme.camera.common.device.v2.Camera2CaptureSessionProxy.SessionOperatorInfo;
import com.freeme.camera.common.device.v2.Camera2Proxy.RequestCreatorInfo;
import com.freeme.camera.common.device.v2.Camera2Proxy.SessionCreatorInfo;
...
class Camera2Handler extends HistoryHandler {
    ...
    Camera2Handler(String cameraId, @Nonnull Looper looper, @Nonnull Handler respondHandler,
        ...
        mTag = new LogUtil.Tag("API2-Handler-" + cameraId);
        mCameraId = cameraId;
