...
import com.freeme.camera.common.device.CameraOpenException;
import com.freeme.camera.common.device.CameraOpenException.ExceptionType;
import com.freeme.camera.common.device.CameraStateCallback;
...
public class Camera2DeviceManagerImpl extends CameraDeviceManager {
    ...
    private class Camera2ProxyCreatorImpl extends CameraProxyCreator {
        ...
        Camera2ProxyCreatorImpl(String cameraId) {
            ...
            mThreadLock.unlock();
            mHandlerTag = new LogUtil.Tag("API2-De-Handler-" + cameraId);
            mRespondTag = new LogUtil.Tag("API2-De-Respond-" + cameraId);
        }
        ...
        private class RespondCameraHandler extends Handler {
            ...
            private Camera2Proxy.StateCallback mOpenStateCallback;
