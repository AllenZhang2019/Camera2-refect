...
package com.freeme.camera.common.device.v1;
...
import com.freeme.camera.common.device.CameraStateCallback;
import com.freeme.camera.common.loader.FeatureLoader;
...
public class CameraDeviceManagerImpl extends CameraDeviceManager {
    ...
    private class CameraProxyCreatorImpl extends CameraProxyCreator {
        ...
        CameraProxyCreatorImpl(String cameraId) {
            super(CameraDeviceManagerFactory.CameraApi.API1, cameraId);
            mThreadLock.lock();
            mRespondHandler = new RespondCameraHandler(mRespondThread.getLooper());
            mThreadLock.unlock();
            mHandlerTag = new LogUtil.Tag("API1-Handler-" + cameraId);
            mRespondTag = new LogUtil.Tag("API1-Respond-" + cameraId);
        }
            ...
            private void retryOpenCamera() {
                try {
                    ...
                    if (isNeedRetryOpen()) {
                        ...
                        Log.i("zhangxu","----------------------mRetryCount:"+mRetryCount);
                        retryOpenCamera();
                        return;
                    }
