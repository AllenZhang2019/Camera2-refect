...
public interface IFeatureEntry {
     ...
     */
    boolean isSupport(CameraDeviceManagerFactory.CameraApi currentCameraApi, Activity activity);
     ...
     */
    void notifyBeforeOpenCamera(@Nonnull String cameraId, @Nonnull CameraDeviceManagerFactory.CameraApi cameraApi);
