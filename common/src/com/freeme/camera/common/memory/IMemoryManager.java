...
public interface IMemoryManager {
    ...
    public interface IMemoryListener {
         ...
         *
         * @param state {@MemoryAction}
         */
        public void onMemoryStateChanged(MemoryAction state);
    }
    /**
     * Add a new listener that is informed about upcoming memory events.
     * @param listener when memory state is changed, this listener will be notified.
     */
    void addListener(IMemoryListener listener);

    /**
     * Removes an already registered listener.
     * @param listener the memory listener will be removed.
     */
