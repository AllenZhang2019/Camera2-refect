...
import com.freeme.camera.common.relation.RestrictionDispatcher;
...
public class SettingManager implements ISettingManager,
    ...
    public void init(String cameraId, IApp app,
                     ICameraContext cameraContext, CameraDeviceManagerFactory.CameraApi currentCameraApi) {
        mTag = new LogUtil.Tag(SettingManager.class.getSimpleName() + "-" + cameraId);
        ...
        if (CameraDeviceManagerFactory.CameraApi.API1 == currentCameraApi) {
            mSettingDeviceRequesterProxy = new SettingDeviceRequesterProxy();
        } else if (CameraDeviceManagerFactory.CameraApi.API2 == currentCameraApi) {
