 ...
 */
package com.freeme.camera.common.setting;
...
import com.freeme.camera.common.setting.ISettingManager.SettingDevice2Requester;
...
public abstract class SettingBase implements ICameraSetting {
    ...
    protected static final String KEY_VOLUME_CAPTURE = "key_volume_capture";
    protected static final String DEFAULT_VOLUME_CAPTURE = "on";
    protected static final String KEY_GRID_LINE = "key_grid_line";
    protected static final String DEFAULT_GRID_LINE = "off";
    protected static final String KEY_RESTORE_SETTINGS = "key_restore_settings";
    protected static final String KEY_TOUCH_CAPTURE = "key_touch_capture";
    protected static final String DEFAULT_TOUCH_CAPTURE = "off";
    protected static final String KEY_ZSD = "key_zsd";
    protected static final String KEY_DEFAULT_KEY_ZSD = "key_default_zsd";

    protected static final String KEY_SHUTTER_SOUND = "key_shutter_sound";
    protected static final String DEFAULT_SHUTTER_SOUND = "on";
    protected static final String KEY_MIRROR_CAPTURE = "key_mirror_capture";
    protected static final String DEFAULT_MIRROR_CAPTURE = "off";
    protected static final String KEY_AUTO_EXIT = "key_auto_exit";
    protected static final String DEFAULT_AUTO_EXIT = "on";
    protected static final String KEY_FOCUS_SOUND = "key_focus_sound";
    protected static final String DEFAULT_FOCUS_SOUND = "on";
    protected static final String KEY_ABOUT_CAMERA = "key_about_camera";
    protected static final String KEY_PICTURE_SIZE = "key_picture_size";
    protected static final String KEY_DEFAULT_PICTURE_SIZE = "key_default_picture_size";
    protected static final String KEY_FACE_DETECTION = "key_face_detection";
    protected static final String DEFAULT_FACE_DETECTION = "on";
    protected static final String KEY_VIDEO_QUALITY = "key_video_quality";
    protected static final String KEY_DEFAULT_VIDEO_QUALITY = "key_default_video_quality";
