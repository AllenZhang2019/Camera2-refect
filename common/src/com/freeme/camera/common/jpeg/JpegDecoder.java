...
public abstract class JpegDecoder {
    ...
    /**
     * Get an jpeg decoder instance.
     *
     * @param surfaceTexture The surface texture object.
     * @return An instance of jpeg decoder.
     */
    ...
    /**
     * Decode jpeg data to surface.
     *
     * @param jpegData The input data.
     */
    public abstract void decode(byte[] jpegData);
